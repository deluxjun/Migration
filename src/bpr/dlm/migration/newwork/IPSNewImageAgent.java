...
public class IPSNewImageAgent {
	...
	IPSNewImageAgent(String idletime, String shfile) throws Exception{
...
//		    	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			IPSNewImageAgent agent = new IPSNewImageAgent(args[0],args[1]);
			IPSNewImageAgent.setStatus(AGENT_RUNNING);

			if (agent.run()){
			}
			
			IPSNewImageAgent.setStatus(AGENT_END);
		} catch (Exception e) {
			e.printStackTrace();
		}
